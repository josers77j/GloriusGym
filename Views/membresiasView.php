...
<div class="container"><br>
    <div class="row">
        <div class="col-4">
            <?php
            include("../Modals/membresiaCreate.php");
            ?>
        </div>
                ...
                <div class="row g-3 m-1 p-2">
                    ...
                    <div class="col-auto my-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="busqueda-membresias" placeholder="Buscar membresia..." aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
