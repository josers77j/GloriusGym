  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Empleados c:</h1>
          ...
          <div class="row">
            <div class="form-group col-6">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Valeria Saravia">
            ...
            <div class="form-group col-6">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Tomoya116">
            ...
            <div class="form-group col-12">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="direccion" name="direccion" placeholder="calle #500 ciudad colonia">
            ...
            <div class="form-group col-12">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="correo" name="correo" placeholder="valery@gmail.com">
            ...
            <div class="form-group col-6">
              ...
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="salario" name="salario" placeholder="360.00">
