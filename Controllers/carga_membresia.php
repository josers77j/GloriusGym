...
$sql = "SELECT * FROM tbl_membresias WHERE nombre LIKE '%".$buscar."%' ORDER BY nombre ASC LIMIT ".$inicio.", ".$limitReg;
...
$sqlCount = "SELECT COUNT(*) as total_registros FROM tbl_membresias WHERE nombre LIKE '%".$buscar."%'";
