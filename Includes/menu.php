          ...
          <li class="nav-item mx-1 w-100">
            ...
            <div class="collapse show" id="account-collapse1">
              <ul class="btn-toggle-nav list-unstyled pb-1 small" id="submenu3" data-bs-parent="#menu">
                <li class="w-100">
                  <a href="../Views/miembrosView.php" class="nav-link px-0 aProperties text-white" id="my-element">
                    <i class="bi bi-person-badge"></i><span class="d-none d-sm-inline text-truncate"> Miembros</span> </a>
                </li>
                <li>
                  <a href="../Views/membresiasView.php" class="nav-link px-0 text-white" id="my-element"><i class="bi bi-card-checklist"></i><span class="d-none d-sm-inline text-truncate"> Membresias</span></a>
                </li>
                <li>
                  <a href="../Views/asistenciasView.php" class="nav-link px-0 text-white d-sm-block"><i class="bi bi-journal"></i> <span class="d-none d-sm-inline text-truncate">Asistencias</span></a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item mx-1 w-100">
            ...
            <div class="collapse show" id="account-collapse2">
              <ul class="btn-toggle-nav list-unstyled pb-1 small" id="submenu3" data-bs-parent="#menu">
                ...
                <li class="w-100">
                  <a href="../Views/usuariosView.php" class="nav-link px-0 aProperties text-white <?= $permiso ?>">
                    <i class="bi-people"></i> <span class="d-none d-sm-inline"> Usuarios</span> </a>
                </li>
                <li class="w-100">
                  <a href="../Views/empleadosView.php" class="nav-link px-0 aProperties text-white <?= $permiso ?>">
                    <i class="bi bi-person-vcard"></i><span class="d-none d-sm-inline"> Empleados</span> </a>
                </li>
                <li class="w-100">
                  <a href="../Views/rolesView.php" class="nav-link px-0 aProperties text-white <?= $permiso ?>">
